...
class Ui_StyleEditorDialog(object):
    def setupUi(self, StyleEditorDialog):
        ...
        #
        self.uiLinkStyleLabel = QtWidgets.QLabel(self.uiStyleSettingsGroupBox)
        self.uiLinkStyleLabel.setObjectName("uiLinkStyleLabel")
        self.formLayout.setWidget(4, QtWidgets.QFormLayout.LabelRole, self.uiLinkStyleLabel)
        self.uiLinkStyleComboBox = QtWidgets.QComboBox(self.uiStyleSettingsGroupBox)
        self.uiLinkStyleComboBox.setObjectName("uiLinkStyleComboBox")
        self.formLayout.setWidget(4, QtWidgets.QFormLayout.FieldRole, self.uiLinkStyleComboBox)
        self.uiLinkStyleFactorLabel = QtWidgets.QLabel(self.uiStyleSettingsGroupBox)
        self.uiLinkStyleFactorLabel.setObjectName("uiLinkStyleFactorLabel")
        self.formLayout.setWidget(5, QtWidgets.QFormLayout.LabelRole, self.uiLinkStyleFactorLabel)
        self.uiLinkStyleFactorSpinBox = QtWidgets.QSpinBox(self.uiStyleSettingsGroupBox)
        self.uiLinkStyleFactorSpinBox.setMinimum(0)
        self.uiLinkStyleFactorSpinBox.setMaximum(10)
        self.uiLinkStyleFactorSpinBox.setProperty("value", 5)
        self.uiLinkStyleFactorSpinBox.setObjectName("uiLinkStyleFactorSpinBox")
        self.formLayout.setWidget(5, QtWidgets.QFormLayout.FieldRole, self.uiLinkStyleFactorSpinBox)
        #
        ...
        self.formLayout.setWidget(6, QtWidgets.QFormLayout.LabelRole, self.uiBorderRadiusLabel)
        ...
        self.formLayout.setWidget(6, QtWidgets.QFormLayout.FieldRole, self.uiBorderRadiusSpinBox)
        #
    ...
    def retranslateUi(self, StyleEditorDialog):
        ...
        self.uiLinkStyleLabel.setText(_translate("StyleEditorDialog", "Link style:"))
        self.uiLinkStyleFactorLabel.setText(_translate("StyleEditorDialog", "Style factor"))
